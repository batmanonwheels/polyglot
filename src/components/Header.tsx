...
const Header = ({ text, profile }: HeaderProps) => {
	...
	// if (profile) {
	// 	return (
	// 		<header className='z-20 flex h-16 w-full items-center justify-between p-5 md:h-32 md:flex-col'>
	...
	// 					</svg>
	// 				</button>
	// 				<h1 className='w-4/6 font-sans text-3xl font-bold '>{text}</h1>
	...
	return (
		<header className='z-20 h-16 w-full items-center justify-between px-5 py-4 pb-5 md:flex md:mx-auto md:h-40 md:flex-col md:px-10'>
			<div className='hidden justify-between gap-4 items-center md:flex w-full'>
